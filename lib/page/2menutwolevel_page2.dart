...
class MenuTwolevelPage2 extends StatelessWidget {
  const MenuTwolevelPage2({
    Key? key,
  }) : super(key: key);
  ...
  Future<List<Menu>> fetchMenus1() async {
    ...
    final url = Uri.parse(
      ...
      'https://gsstojson.herokuapp.com/api?id=1uBvyfmwv8LsuAbp87voiXmQYSchk4p1BlqIMxGtzSfg&sheet=3&columns=false&catid=$catid',
    );
    print(url);
